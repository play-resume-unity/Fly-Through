...
public class SpawnManager : MonoBehaviour {
    ...
    [SerializeField] private Pilot[] planesPrefabs;
    [SerializeField] private Pilot currentPlane;



    [SerializeField] private string[] poolName;
    [SerializeField] private Transform initialRingSpawnPos;
    [SerializeField] private LevelVariations currentVariations;
    ...
    private void Awake(){
        ...
        int rand = Random.Range(0,planesPrefabs.Length);
        currentPlane = Instantiate(planesPrefabs[rand],planeSpawnPoint.position,planeSpawnPoint.rotation);
        followCam.m_Follow = currentPlane.transform;
        followCam.LookAt = currentPlane.transform;
    ...
    public void Init(){
        ...
        if(ring.TryGetComponent<LevelVariations>(out LevelVariations newVaritaions)){
